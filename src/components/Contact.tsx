            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="mailto:contact@shreyasgharad.com" className="text-gray-600 hover:text-blue transition-colors">
                    contact@shreyasgharad.com
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="tel:+919876543210" className="text-gray-600 hover:text-green transition-colors">
                    +91 98765 43210
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="https://linkedin.com/in/shreyasgharad" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-blue transition-colors">
                    linkedin.com/in/shreyasgharad
                  </a>
                </div>
              </div>
